// 1. Donnees/ variables / constantes qui vont etre réutiliser globale
// 2. selecteur et balises HTML globale : querySelector
// 3. Foncstions, mais sans les appeler
// 4. Execution
...
/* document.addEventListener("DOMContentLoaded", function () {
  ...
  function genererNavigation(lien) {
    ...
    liensNavigation.forEach(function (lien) {
      ...
      navLinks.insertAdjacentHTML("beforeend", gabarit);
    });
...
// DOMContentLoaded" ou lieu de Init = pas nécessaire  car on a
// mis la fonction 'defer' dans le script de la page 
